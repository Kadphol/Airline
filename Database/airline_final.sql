...
--
-- Host: localhost
-- Generation Time: May 30, 2019 at 05:08 AM
...
INSERT INTO `Billing` (`BillingID`, `CardNo`, `MemberID`, `MemberPromotionID`, `PromotionCode`, `PayDate`, `AmountPaid`) VALUES
(1, '1234567890', 1, NULL, NULL, '2019-05-28', 10817.9),
(2, '7382930475869047', 12, NULL, NULL, '2019-05-28', 18527.9),
(3, '0198546738267456', 12, NULL, NULL, '2019-05-28', 42027.9),
(4, '1234', 12, NULL, NULL, '2019-05-28', 23527.9);
...
INSERT INTO `Booking` (`BookingID`, `FlightID`, `PassengerID`, `BillingID`, `SeatID`, `AddOnID`) VALUES
(1, 3, 1, 1, '06_A', 5),
(2, 16, 3, 2, '04_C', 3),
(3, 22, 4, 3, '01_G', 2),
(4, 16, 5, 4, '01_F', 1);
...
(3, '2019-05-27 09:35:00', '2019-05-27 10:35:00', 23, 1, 'G22', 'A', 9890, '\"06_A\",\"05_A\"'),
(6, '2019-05-03 08:00:00', '2019-05-04 11:00:00', 19, 1, 'A33', 'A', 45000, ''),
(7, '2019-05-28 01:25:00', '2019-05-28 05:25:00', 13, 1, 'G11', 'A', 34700, ''),
(16, '2019-05-28 00:00:00', '2019-05-28 06:00:00', 3, 2, 'G09', 'A', 13000, '\"04_C\",\"01_F\"'),
...
(22, '2019-01-14 01:00:00', '2019-01-14 01:00:00', 1, 2, 'A10', 'A', 26500, '\"01_G\"'),
...
(1, 'eiei@gmail.com', '12345', 'm', 'Namjoon', 'Kim', '1999-10-31', '+66', 65445620, 'pa123456789', 100),
...
INSERT INTO `Passenger` (`PassengerID`, `Sex`, `FirstName`, `LastName`, `DOB`) VALUES
(1, 'M', 'Namjoon', 'Kim', '1999-10-31'),
(2, 'M', 'Namjoon', 'Kim', '1999-10-31'),
(3, 'M', 'someone', 'somename', '1999-09-11'),
(4, 'F', 'Hello', 'World', '1986-10-20'),
(5, 'F', 'Namjoon', 'Kim', '2019-05-01');
...
INSERT INTO `PaymentMethod` (`CardNo`, `CardType`, `ExpiredDate`, `CVV`) VALUES
('0198546738267456', 'UnionPay', '06/18', 656),
('1234', 'Master Card', '01/16', 123),
('1234567890', 'Master Card', '01/18', 123),
('7382930475869047', 'Visa', '02/18', 223);
...
--
ALTER TABLE `Booking`
  MODIFY `BookingID` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `Passenger`
  MODIFY `PassengerID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
